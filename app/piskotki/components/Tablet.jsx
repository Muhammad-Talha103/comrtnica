...
export default function Tablet() {
    return (
        <div>
            <h1 className="font-medium text-[24px] leading-[27px] tracking-[0] mb-[25px]">Politika piškotkov</h1>
            <p className="font-light text-[16px] leading-[27px] tracking-[0] mb-6">Nazadnje posodobljeno: 12. september 2025</p>
            <p className="font-light text-[16px] leading-[27px] tracking-[0] mb-6">Na spletni strani osmrtnica.com uporabljamo piškotke in podobne tehnologije, da zagotovimo pravilno delovanje strani, izboljšamo uporabniško izkušnjo ter analiziramo obisk. Ta politika pojasnjuje, kaj so piškotki, katere vrste uporabljamo in kako lahko sami upravljate svoje nastavitve piškotkov.</p>

            <div>
                <p className="font-medium text-[16px] leading-[27px] tracking-[0] mb-[5px]">Kaj so piškotki?</p>
            ...
            <div>
                <p className="font-medium text-[16px] leading-[27px] tracking-[0] mb-[5px]">Kako uporabljamo piškotke?</p>
                <p className="font-light text-[16px] leading-[27px] tracking-[0] mb-6">
            ...
            <div>
                <p className="font-medium text-[16px] leading-[27px] tracking-[0]">Piškotki na osmrtnica.com</p>
                <p className="font-light text-[16px] leading-[27px] tracking-[0] mb-6">Nujno potrebni piškotki za delovanje spletnega mesta</p>

                <p className="font-light text-[16px] leading-[27px] tracking-[0] mb-6">__Host-next-auth.csrf-token |  Varnostni piškotek za zaščito prijave (CSRF zaščita)  | Trajanje: Seja (dokler je brskalnik odprt) | osmrtnica.com |</p>
                <p className="font-light text-[16px] leading-[27px] tracking-[0] mb-6">__Secure-next-auth.callback-url  | Shrani naslov, kamor se uporabnik preusmeri po prijavi ali odjavi. | Trajanje: Seja | osmrtnica.com |</p>
                <p className="font-light text-[16px] leading-[27px] tracking-[0] mb-6">nextauth.message | Začasno shrani sporočila o prijavi/napakah avtentikacije  | Trajanje: Seja | osmrtnica.com |</p>
                <p className="font-light text-[16px] leading-[27px] tracking-[0] mb-6">cookieyes-consent | Shranjuje uporabnikove nastavitve glede soglasja za piškotke. Piškotek ne zbira in ne shranjuje nobenih osebnih podatkov obiskovalcev spletnega mesta.  | Trajanje: 1 leto                           | osmrtnica.com |</p>

            </div>

            <div>
                <p className="font-medium text-[16px] leading-[27px] tracking-[0] mb-[5px]">Upravljanje piškotkov</p>
                <p className="font-light text-[16px] leading-[27px] tracking-[0]">Piškotke lahko kadarkoli upravljate prek pasice za soglasje CookieYes, kjer lahko sprejmete ali zavrnete posamezne kategorije piškotkov. Piškotke lahko upravljate tudi neposredno v nastavitvah vašega spletnega brskalnika.</p>
                ...
                <p className="font-light text-[16px] leading-[27px] tracking-[0]">Različni brskalniki ponujajo različne načine za blokiranje in brisanje  piškotkov, ki jih uporabljajo spletna mesta. Nastavitve brskalnika lahko prilagodite tako, da blokirate ali izbrišete piškotke. Spodaj so  povezave do podpornih dokumentov o upravljanju in brisanju piškotkov v  glavnih spletnih brskalnikih.</p>
                <ul className="list-disc marker:text-gray-400 pl-5 font-light flex flex-col gap-1">
                    <li>Chrome: <a className="underline underline-offset-[4px]" href="https://support.google.com/accounts/answer/32050">https://support.google.com/accounts/answer/32050</a></li>
                    <li>Safari: <a className="underline underline-offset-[4px]" href="https://support.apple.com/en-in/guide/safari/sfri11471/mac">https://support.apple.com/en-in/guide/safari/sfri11471/mac</a></li>
                ...
                <p className="font-light text-[16px] leading-[27px] tracking-[0] mb-6">Če uporabljate drug spletni brskalnik, se obrnite na njegovo uradno dokumentacijo za podporo.</p>
            </div>

            <div>
                <p className="font-medium text-[16px] leading-[27px] tracking-[0] mb-[5px]">Vaše pravice</p>
                <p className="font-light text-[16px] leading-[27px] tracking-[0]">V skladu z zakonodajo (GDPR, ZVOP-2) imate pravico do:</p>
                <ul className="list-disc text-[16px] marker:text-gray-400 pl-5 font-light">
                ...
                <p className="font-light text-[16px] leading-[27px] tracking-[0] mb-6">Za uveljavljanje pravic nas lahko kontaktirate preko spodaj navedenih podatkov.</p>
            </div>
