...
const PolitikaZasebnostiPage = () => {
    return (
        <main className="flex justify-center px-4 py-12 bg-[#ecf0f3] min-h-screen">
            <div className="w-[700px] mx-auto px-6 py-12 text-gray-800">
                <h1 className="text-3xl font-semibold mb-10">Politika zasebnosti</h1>
...
export default PolitikaZasebnostiPage;
