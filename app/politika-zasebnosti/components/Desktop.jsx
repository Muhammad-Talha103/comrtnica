    ...
    return (
        <main className="">
            <div>
                ...
                <div className="text-[16px] leading-[27px] font-light">
                    <section>
                    ...
                    <section>
                        ...
                        <p className="font-light text-[16px] leading-[27px] tracking-[0] mb-6">Pravna podlaga za obdelavo osebnih podatkov temelji na:</p>
                        <ul className="list-disc list-inside space-y-1">
                    ...
                    <section>
                        <h2 className="font-medium text-[16px] leading-[27px] tracking-[0] mb-[5px]">5. Hramba osebnih podatkov</h2>
                        <p className="font-light text-[16px] leading-[27px] tracking-[0] mb-6">
                    ...
                    <section>
                        <h2 className="font-medium text-[16px] leading-[27px] tracking-[0] mb-[5px]">6. Pravice uporabnikov</h2>
                        <p className="font-light text-[16px] leading-[27px] tracking-[0] mb-6">Uporabniki imajo pravico:</p>
                        <ul className="list-disc list-inside space-y-1">
                    ...
                    <section>
                        ...
                        <p className="font-light text-[16px] leading-[27px] tracking-[0] mb-6">Pri uporabi njihovih storitev se lahko obdelujejo naslednji osebni podatki:</p>
                        <ul className="list-disc list-inside space-y-1">
