      ...
      <div className="bg-[#F9EBD4] min-h-[100vh] text-[#3C3E41] relative">
        ...
        <div className="flex flex-col items-center pt-[200px] w-full px-4 max-w-[720px] mx-auto">
          ...
          <p className="font-light text-[16px] mt-[50px]">
            Poleg mesečnih Skrbnikov, digitalnih kartic sožalja, zahval in vabil
            ter nekaterih novosti v nadaljevanju, pripada prvim cvetličarnam še
            nekaj dodatnih ugodnosti.
          </p>
            ...
            <div>
              ...
              <ul className="list-disc list-inside text-[16px] mt-4 space-y-0">
                <li>
                  ...
                  <div className="text-[#6D778E] mt-1 pl-5">
                    ...
                    dvojno dobo – z uporabo vaše kode. Mesečni Skrbnik traja dva
                    meseca. Letni Skrbnik, če se zanj stranka odloči traja 2
                    leti, torej eno leto je plačljivo, drugo pa jim s svojo kodo
                    brezplačno podarite vi, 6-letni Skrbnik traja 12 let.
                    Predstavlja konkurenčno prednost v primerjavi s
                    cvetličarnami, ki bi se vključile kasneje in zagotavlja
                    zadovoljstvo vaših strank, ki jim podarite prav to, česar si
                    želijo oz so morda celo že naročili, obenem pa je lahko to
                    darilo učinkovito orodje za vašo lastno promocijo, o vas se
                    govori).
                  </div>
                </li>
              ...
              <ul className="list-disc list-inside text-[16px] mt-4 space-y-0">
                <li>
                  ...
                  <div className="text-[#6D778E] mt-1 pl-5">
                    (kot velja po uradnem ceniku letos poleti. Pomeni, da četudi
                    bi kdaj v naslednjih letih spremenili ceno naročnine, bo
                    vaša cena ostala nespremenjena za isti paket vse do leta
                    2030)
                  </div>
                </li>
                ...
                <li>
                  ...
                  <span className="text-[#6D778E] mt-1 pl-1">
                    ...
                    kdaj bo to oglaševanje izvršeno; bo pa to zagotovo v vašem
                    lokalnem <br />
                    <span className="pl-5"></span>okolju in do konca leta 2025)
                  </span>
                </li>
                ...
                <li>
                  ...
                  <span className="text-[#6D778E] mt-1 pl-1">
                    ...
                    <br />
                    <span className="pl-5"></span> ko drugi še niso vključeni in
                    ko je darilo za stranke še bolj nepričakovano / ko o tem še
                    ne vedo)
                  </span>
                </li>
              </ul>
              ...
              <ul className="list-disc list-inside text-[16px] mt-4 space-y-0">
                <li>
                  ...
                  <div className="text-[#6D778E] mt-1 pl-5">
                    ...
                    spremenili ceno naročnine, bo vaša cena ostala nespremenjena
                    za isti paket vse do leta 2030)
                  </div>
                </li>
                ...
                <li>
                  ...
                  <span className="text-[#6D778E] mt-1 pl-1">
                    ...
                    to zagotovo
                    <br />
                    <span className="pl-5"></span> v vašem lokalnem okolju in do
                    konca leta 2025)
                  </span>
                </li>
                ...
                <li>
                  ...
                  <span className="text-[#6D778E] mt-1 pl-1">
                    ...
                    ko je darilo za
                    <br />
                    <span className="pl-5"></span>stranke še bolj nepričakovano
                    / ko o tem še ne <br />
