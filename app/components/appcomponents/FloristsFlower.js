    ...
    <div className="relative w-full h-[284px] overflow-hidden flex justify-center items-center mx-auto">
      ...
      >
        <div className="flex w-[476px] h-[178px] tablet:w-[301px] absolute tablet:mt-[53px] tablet:mr-[74.5px] mobile:mt-[60px] mobile:mr-[87px] mr-[78px] mt-[53px] mb-[98px] flex-col items-center">
          <h2 className="flex w-full text-[40px] mobile:text-[28px] h-[47px] text-[#FFFFFF] tablet:text-[#1E2125] mobile:text-[#1E2125] items-center justify-center  font-variation-customOpt40 mobile:font-variation-customOpt28 whitespace-nowrap">
            Imate cvetličarno
          </h2>
          <h3 className="flex w-full text-[24px] h-[28px] font-bold mt-[10px] mb-[46px] mobile:mt-0 mobile:mb-[37px] text-[#FFFFFF] tablet:text-[#1E2125] mobile:text-[#1E2125] items-center justify-center font-variation-customOpt24wght700">
            Sodelujmo
          </h3>
