...
const MegaMenu = () => {
  ...
  return (
    <>
    {/* Mobile Menu Button - Only visible in mobile view when menu is closed */}
...
<span className="text-black bg-white px-2 py-1 cursor-pointer btn-close" onClick={() => setShowMobileMenu(false)}> X </span>
        ...
        <div 
      className="d-none d-md-block z-10 overflow-y-auto pb-[200px] flex flex-col overflow-x-hidden mt-[5px] desktop:pt-[20px] tablet:mt-[2px] items-center gap-y-8 h-screen w-screen  mx-auto bg-[#00000080] px-[50px] mobile:px-5 
