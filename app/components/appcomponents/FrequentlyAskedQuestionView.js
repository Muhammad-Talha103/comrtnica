                  ...
                  faq.answer && (
                    <React.Fragment key={index}>
                      <button
                        ...
                        }  border-t border-t-[#D4D4D4] px-5 mobile:px-[8px]`}
                      >
                      ...
                      {openIndex === index && (
                        <div
                          className="flex ql-editor text-black w-full text-[14px] flex-col ml-4 mobile:px-0 "
            ...
            ? faqs.map((faq, index) => (
                <React.Fragment key={index}>
                  <button
                    ...
                    className={`flex w-full justify-between items-center gap-4 border-t border-t-[#D4D4D4] px-3.5 mobile:px-0 py-4 mobile:py-2 ${
