...
const UpdateObituary = ({ set_Id, setModal }) => {
    ...
    const fetchObituary = async (orbituaryId) => {
        try {
            ...
            try {
                ...
                response.birthDate && setBirthDate(response.birthDate ? new Date(response.birthDate) : null);
                response.deathDate && setDeathDate(response.deathDate ? new Date(response.deathDate) : null);
            } catch (err) {
