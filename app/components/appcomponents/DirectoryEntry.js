...
const DirectoryEntry = () => {
  const containerArray1 = [
    {
      ...
      discription:
        "Vpis v imenik BREZ kontaktnih podatkov in povezav. Uvrstitev v imeniku na spodnja mesta.",
    },
  ];
  const containerArray1_Mobile = [
    {
      id: 1,
      title: "Vpis v imenik lokalnih cvetličarn",
      discription:
        "Vpis BREZ kontaktnih podatkov in povezav do socialnih omrežij. Uvrstitev na spodnja mesta v imeniku.",
    },
  ];
  ...
  const containerArray2 = [
    {
      ...
      title: "Vpis v imenik lokalnih cvetličarn",
      discription:
        "Vpis z vsemi kontaktnimi podatkimi in povezavami do socialnih omrežij.",
    },
    {
      id: 2,
      title: "Pojavljanje na lokalnih osmrtnicah",
      discription:
        "Vaša cvetličarna se objavlja na straneh lokalnih osmrtnic, skupaj s povezavo do vaše strani.",
    },
    {
      id: 3,
      title: "Brezplačno objavljanje osmrtnic",
      discription:
        "Pomagate žalujočim z brezplačno objavo, vaša cvetličarna pa se pojavlja poudarjeno na žalni strani.",
    },
    {
      id: 4,
      title: "Brezplačna lastna spletna stran",
      discription:
        "Stran si izdelate sami in jo kasneje sami dopolnjujete glede na potrebe. Enostavno je!",
    },
    {
      id: 5,
      title: "Brezplačna darila za vaše stranke",
      discription:
        "Digitalne kartice, mesečni Skrbnik. Ta darila mi na naši strani ne nudimo, zato bodo iskali in poiskali vas.",
    },
    {
      id: 6,
      title: "Več strank",
      discription:
        "Tudi zaradi teh brezplačnih daril bo več strank prišlo v vašo trgovino, kot pa v cvetličarno, ki ni v našem sistemu. Če koristi siceršnjega oglaševanja povsem odmislimo.",
    },
    {
      id: 7,
  ...
  const containerArray3 = [
    {
      id: 1,
      title: "Poleg navedenih v prejšnjem delu",
      discription:
        "Občasno je mogoča še vrsta drugih promocij, zato nas kontaktirajte in zagotovo bomo našli ugodne rešitve.",
    },
  ];
  ...
  const extraObj = {
    ...
    discription:
      "v primeru letnega plačila + številne dodatne promocije. Kontaktirajte nas in preverite trenutne.",
  };
  const extraObj2 = {
    id: 0,
  ...
  const HowToProceed = ({ isMobile = false }) => (
    <div
      className={`flex ${
        isMobile
          ? "flex-col w-full mt-[28px]"
          : "flex-row w-full mt-[35px] pl-4 pr-5"
      }`}
    >
      <Image
      ...
      <div className={`flex flex-col ${isMobile ? "mt-3" : "ml-3"}`}>
        ...
        <p className="text-[#3C3E41] text-[10px] font-normal">
          {isMobile ? (
            <>
              Pred koncem avgusta vam bomo poslali ponudbo za sklenitev
              naročnine.
              <br />
              <br />V primeru, da vam sodelovanje ne prinaša koristi, enostavno
              počakajte do sredine septembra, ko bo vaša stran umaknjena in
              enako dostop do uporabniškega računa.. Morebitna reaktivacija, tj
              obnovitev vaše spletne strani bo mogoča še do konca julija, v
              kolikor si premislite, kasneje pa gre v izbris.
              <br />
              <br />
              Pri letni pogodbi sta zadnja dva meseca pogodbenega leta
              brezplačna. V primeru prekinitve letne pogodbe se tako obračunajo
              koriščeni meseci po ceni mesečnega najema, vnaprej plačan
              preostanek pa se vrne naročniku brez vprašanj. S tem zagotovimo
              naročniku prijazno pogodbo, brez rizika zaradi dolgoročnosti.
            </>
          ) : (
            <>
              Pred koncem avgusta vam bomo poslali ponudbo za sklenitev
              ...
              <br />V primeru, da vam sodelovanje ne prinaša koristi, enostavno
              počakajte do sredine septembra, ko bo vaša stran umaknjena in
              enako dostop do uporabniškega računa.
              <br /> Pri letni pogodbi sta zadnja dva meseca pogodbenega leta
              brezplačna. V primeru prekinitve letne pogodbe se tako obračunajo
              koriščeni meseci po ceni mesečnega najema, vnaprej plačan
              preostanek pa se vrne naročniku brez vprašanj. S tem zagotovimo
              naročniku prijazno pogodbo, brez rizika zaradi dolgoročnosti.
    ...
    <div className="flex justify-center bg-[#F9EBD466] mobile:w-full">
      <div className="flex flex-col py-[65px] desktop:py-[105px] tablet:py-[75px] mobile:w-full mobile:px-4">
        <div className="flex self-center items-center h-[48px]">
          <h2 className=" flex mobile:text-[28px] text-[40px] text-[#1E2125] font-variation-customOpt40 font-normal">
            Vpis v imenik cvetličarn
          </h2>
        </div>
