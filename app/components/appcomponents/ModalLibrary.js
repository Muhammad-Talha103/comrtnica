...
export default function ModalLibrary({
  ...
  return (
    <Modal
      ...
      classNames={{
        backdrop:
          "bg-[#00000070] min-h-screen flex items-center justify-center py-10",
      }}
    >
      <ModalContent className="flex items-center justify-center w-full ">
        <div className="flex flex-col w-full items-center justify-center">
          ...
          <div
            className={`flex flex-col bg-[#E8F0F6]  rounded-2xl  p-4  ${
              select_id == "22" &&
              "desktop:mt-[200px] mobile:mt-[100px] tablet:mt-[150px]"
            }`}
          >
            <div
              onClick={() => {
