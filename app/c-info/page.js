        ...
        <section className="mt-10 text-[16px] space-y-6 leading-[1.6] mobile:w-[354px] w-[706px]">
          <div>
            ...
            <p className="font-light text-[16px]">
              Priložnost biti na pravem mestu, ob pravem času, ko vas vaše
              stranke potrebujejo.
              <br />
              <br />
          ...
          <div>
            <h3 className="font-semibold text-[18px] mb-1 ">
              Kakšne ‘digitalne produkte za naše stranke’?
            </h3>
            <p className="font-light text-[16px]">
              Spominsko stran (s statusom Skrbnika). Mobi digitalna vabila,
              sožalja, zahvale za pošiljanje naprej. Izjemoma tudi možnost
              vpisovanja osmrtnic. In še več brezplačnih produktov v kratkem.
              <br />
              <br />
              To ni obveza; je zgolj konkurenčna prednost, ki jo lahko
              izkoristite in zaradi katerih bodo stranke iskale in tudi obiskale
              vas, ne vaše konkurence, ki (še) ni vključena v sistem. Ker gre za
              zanimive produkte, ki so popolna novost na trgu, ljudje o njih
              govorijo, kar prinaša posredno promocijo vašemu podjetju in
              dodatne obiske vaših klientov, ki jih sicer ne bi bilo.
              <br />
              <br />
              Produkte za vaše stranke zagotovimo brezplačno, vi pa jih sami po
              svoji presoji podarjate naprej.
            </p>
          </div>

          <div>
            <h3 className="font-semibold text-[18px] mb-1 ">
              Kaj, če se ne vključim ali zamudim?
            </h3>
            <p className="font-light text-[16px]">
              Lahko se pridružite kadarkoli kasneje; le nekaj manj ugodnosti bo
              na voljo, npr. možnosti brezplačne izdelave strani, nekaj drugih
              koristi, popustov, oglaševanj, je pa nekaj gotovo - brez
              najmanjšega dvoma se boste v nadaljevanju pridružili, sploh ko
          ...
          <div>
            <h3 className="font-semibold text-[18px] mb-1 ">
              Kakšna bo cena kasneje?
            </h3>
            <p className="font-light text-[16px]">
              Naš cilj je povezati vse lokalne cvetličarne na enem mestu, od
              majhnih z dvema zaposlenima do velikanov, zato smo temu
              prilagodili tudi cene in omogočili sodelovanje vsem.
              <br />
              <br />
          ...
          <div>
            <h3 className="font-semibold text-[18px] mb-1 ">
              Nismo vešči računalnika. Ne bomo znali izdelati svojo stran ali
              pošiljati darila naprej.
            </h3>
            <p className="font-light text-[16px]">
              Sistem je dovršen in avtomatiziran. Potrebno je zgolj dodati svoja
              besedila v za to namenjena okenca in prilepiti slike. V primeru
              težav bomo seveda pomagali do konca otvoritvene akcije, medtem ko
              se bo kasneje predvidoma izdelava strani zaračunavala in vam bomo
              torej stran zgradili mi.
              <br />
              <br />
              Obdarovanje strank z digitalnimi produkti je enostavno in traja
              manj kot minuto, ki je potrebna za vpis elektronskega naslova.
              Tudi vpis osmrtnice ne traja več kot dobro minuto. Tako enostavno
              je!
            </p>
          </div>
          ...
          <div>
            <h3 className="font-semibold text-[18px] mb-1 ">
              Kaj naj storim zdaj, kako naj začnem?
            </h3>
            <p className="font-light text-[16px]">
