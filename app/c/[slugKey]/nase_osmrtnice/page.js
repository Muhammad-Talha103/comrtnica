              ...
              <tbody className="bg-white/40">
                {obituaries && obituaries.length > 0
                  ? obituaries.map((obituary, index) => (
                      ...
                      >
                        <td className="mobile:pr-[19px] mobile:pl-0 px-[19px] py-[28px] tabletUserAcc:py-[16px] mobileUserAcc:py-[16px] text-[#6D778E] leading-none">
                        ...
                        <td>
                          <div className="inline-flex gap-[16px] items-center">
                            ...
                            <svg
                              ...
                              strokeWidth={2.8}
                              stroke="#6D778E"
                              className="size-5 mobile:hidden block"
                            >
                              <path
                                strokeLinecap="round"
                        ...
                        <td className="mobile:pr-0 pr-[25px]">
                          <span
                            ...
                            className="cursor-pointer border-[2px] border-[#0A85C2] bg-white rounded-[6px] mobile:w-[80px] mobile:px-0 px-[11px] py-[5px] flex mobile:justify-center items-center gap-[16px] shadow-md relative left-0 mobile:mx-auto ml-auto "
                          >
                            <img
                              src="/edit.png"
                              alt=""
                              className="w-[26px] h-[26px] mobile:hidden block"
                            />
