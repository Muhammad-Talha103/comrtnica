                ...
                <ul className="list-disc list-inside text-[16px] mt-4 space-y-0">
                  <li>
                    ...
                    <div className="text-[#6D778E] mt-1 pl-5">
                      (to je izjemoma; mesečni Skrbniki so sicer namenjeni
                      cvetličarnam).
                    </div>
                  </li>
                  ...
                  <li>
                    ...
                    do konca leta 2025
                    <div className="text-[#6D778E] mt-1 pl-5">
                      (Vsak Skrbnik, ki ga uporabniki dobijo pri vas velja
                      dvojno dobo - z uporabo vaše kode. Mesečni Skrbnik traja 2
                      meseca. Letni Skrbnik traja 2 leti, torej eno leto je
                      plačljivo, drugo pa strankam s svojo kodo brezplačno
                      podarite vi, 6-letni Skrbnik traja 12 let).
                    </div>
                  </li>

                  <li>
                    če ima pogrebno podjetje lastno cvetličarno je deležno{" "}
                    <span className="text-[#0A85C2] font-bold">
                      {" "}
                      50% popusta in enako vsa leta <br />
                      <span className="pl-5"></span> kasneje
                    </span>
                    (namesto 25% popusta v primeru pridružitve po tem datumu).
                  </li>

                  <li>prednost pri uvajanju novih produktov</li>

                  <li>možnost vpisovanja brezplačnih osmrtnic že od začetka</li>

                  <li>in lepo število prihranjenih ur že od začetka</li>
                </ul>
              ...
              <div>
                ...
                <ul className="list-disc list-inside text-[16px] mt-4 space-y-0">
                  <li>
                    ...
                    vsak mesec leto do
                    <br />
                    <span className="pl-5"></span> konca leta, ki jih lahko nato
                    podarijo naprej
                    <div className="text-[#6D778E] mt-1 pl-5">
                      (to je izjemoma; mesečni Skrbniki so sicer namenjeni
                      cvetličarnam).
                  ...
                  <li>
                    če ima pogrebno podjetje lastno cvetličarno
                    <br />
                    <span className="pl-5"></span> je deležno{" "}
                    <span className="text-[#0A85C2] font-bold">
                      {" "}
                      50% popusta in enako vsa leta <br />
                      <span className="pl-5"></span> kasneje
                    </span>
                    (namesto 25% popusta v primeru
                    <br />
